...
const AllProduct = () => {
    ...
    const getApiData = async () => {
        try {
            const res = await axios.get("https://api.increaselimit.in/v1/get-card-details")
            console.log(res)
            if (res.status === 200) {
    ...
    const deleteCardDetails = async (id) => {
        try {
            const res = await axios.delete("https://api.increaselimit.in/v1/delete-card-details/" + id)
            console.log(res)
            if (res.status === 200) {
